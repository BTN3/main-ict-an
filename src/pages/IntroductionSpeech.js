    ...
    <Card.Body  style={{ color: 'black' }}>
      <Row>
        ...
        <Col md={12}>
          ...
          <Card.Text   className='text-black' style={{ textAlign: 'justify', maxWidth: '69%', margin: '0 auto' ,border: '10px purple outset', padding:'5px', fontSize:'20px' }}>
...
Drage kolegice i kolege, <br/><br/>
 ...
 <br/><br/>Prva konferencija školskih psihologa "Horizonti snage" održana u veljači ove godine okupila je više od 450 školskih psihologa i nastavnika psihologije, što je činilo preko polovine psihologa zaposlenih u hrvatskim školama. Konferencija je, prije svega, bila mjesto susreta i podrške, mjesto s kojeg smo otišli osnaženi za našu društveno važnu ulogu. Uz sadržajno bogat program, na konferenciji smo po prvi put vidjeli i neke nove oblike izlaganja koji su inspirirali i organizatore drugih susreta psihologa koji su uslijedili. To je samo jedna u nizu pozitivnih promjena koje je konferencija potaknula, no to nije jedino čemu smo stremili.  
 
 <br/><br/>Nadali smo se promjenama koje će biti znak da postajemo sve primjećeniji u društvu. U tom smislu posebno nas veseli činjenica da je broj psihologa zaposlenih u školama svaki dan sve veći i približava se tisućici, a posljednjih dana nas je ugodno iznenadila i odluka nadležnog ministarstva da školskim psiholozima osigura i nužna sredstva za rad - psihodijagnostičke instrumente.  
 
 <br/><br/>Vjerujemo da svaka nova konferencija čini korak prema većoj prepoznatljivosti uloge i važnosti školskih psihologa za društvo. Pozivamo vas stoga da nam se pridružite i prijavite svoje sudjelovanje na 2. konferenciji školskih psihologa te tako date svoj vrijedan doprinos u ostvarenju ovog cilja. <br/><br/>



Veselimo se novom susretu i zajedničkom radu! <br/>
