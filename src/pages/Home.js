        ...
        <div className={`grid-item ${selectedButton === 'O aplikaciji za prijavu' ? 'selected' : ''}`}>
          ...
          {selectedButton === 'O aplikaciji za prijavu' && (
            <div className="sectionContent">
              ...
              <p style={{textAlign:'justify'}}><a href='https://horizonti-snage.azurewebsites.net/feesaccomodation/eventregistration'>Prijavi se</a> na 2. konferenciju školskih psihologa "Horizonti snage" na sljedeći način.
              </p><ol>
